    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return data.map((item) {
          ...
          final clockOut = item['clockOutAt'] != null
              ? DateTime.parse(item['clockOutAt'])
              : null;
          ...
          return AttendanceModel(
            ...
            checkOut: clockOut != null
                ? DateFormat('hh:mm a').format(clockOut.toLocal())
                : '--:--',
            totalHours:
                '${(minutesWorked / 60).floor().toString().padLeft(2, '0')}:${(minutesWorked % 60).toString().padLeft(2, '0')}',
